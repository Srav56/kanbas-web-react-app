...
import "./index.css";
import { addAssignment, setAssignment, updateAssignment } from "../reducer";        // Import reducer functions to add, delete, and update assignments.
...
const AssignmentEditor: React.FC = () => {
    ...
    return (
      <div className="col col-sm-9">
        ...
        <div className="row container-fluid">
          ...
          <div className="mb-3 p-1">
            <textarea className="form-control" id="exampleFormControlTextarea1" rows={3} placeholder={assignment?.description}>Assignment Description</textarea>
          </div>
        </div>
        ...
        <div className="row container-fluid mb-3 p-1">
          ...
          <div className="col col-sm-7">
            <div className="col-sm-10 ml-0" style={{width: "600px" }}>
  ...
  <div className="row container-fluid mb-3 p-1">
    ...
    <div className="col col-sm-7">
      <div className="wd-box-submission-type" style={{ border: '1px solid darkgrey', width:'500px', height: 'auto', padding: '20px' }}>
        <div className="row">
  ...
  <div className="row container-fluid mb-3 p-1">
    ...
    <div className="col col-sm-7">
      <div className="wd-box-submission-type" style={{ border: '1px solid darkgrey', width: '500px', height: 'auto', padding: '20px', marginLeft:"10px"}}>
        <div className="row mb-3 pb-1">
        <label htmlFor="Assign" className="">Assign To</label>
          <div className="wd" style={{ border: '0.1rem solid rgb(230, 229, 229)', width: '45vh', padding: '10px', marginLeft:"10px" }}>
        ...
        <div className="row mb-3 pb-1">
          ...
          <input id="due" className="form-control" type="date" style={{width: '45vh', padding: '10px', marginLeft:"10px"}} defaultValue={assignment?.dueDate} />
        </div>
        <div className="row mb-3 pb-1">
          <div className="col col-sm-6">
            <label htmlFor="af" className="">Available From</label>
            <input className="form-control" id="af" type="date" style={{width: '25vh', padding: '10px'}} defaultValue={assignment?.availableFromDate} />
          </div>
          <div className="col col-sm-6">
            <label htmlFor="unt" className="">Until</label>
            <input className="form-control" id="unt" type="date" style={{width: '25vh', padding: '10px'}}  defaultValue={assignment?.untilDate} />
          </div>
        </div>
        <div className="row">
          <button type="button" className="btn btn-dark"><i className="fa-solid fa-plus"></i>Add</button>
        </div>
      </div>
    </div>
  </div>
